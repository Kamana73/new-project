"""School Pro college_management_system
Function views
...
urlpatterns = [
    ...
    # Assignment path for student
    # Assignment paths for student
    path('assignments/', student_views.student_assignments, name='student_assignments'),
    path('submit_assignment/<int:assignment_id>/', student_views.submit_assignment, name='submit_assignment'),
    path('submitted_assignments/', student_views.submitted_assignments, name='submitted_assignments'),

    # Updated URL patterns for staff assignments
    path('manage_assignment/', staff_views.staff_assignments, name='manage_assignment'),
    path('manage_assignment/<int:assignment_id>/', staff_views.manage_assignment, name='manage_assignment_detail'),
    path('create_assignment/', staff_views.create_assignment, name='create_assignment'),
    path('delete_assignment/<int:assignment_id>/', staff_views.delete_assignment, name='delete_assignment'),
    path('view_submitted_assignments/<int:assignment_id>/', staff_views.view_submitted_assignments,
